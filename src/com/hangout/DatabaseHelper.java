...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String[] create = new String[] {
			...
			"create table mgroup(id integer primary key, description text, group_photo_count integer, group_urlname varchar(255), join_mode integer, lat real, lon real, members integer, name varchar(255), organizer_id integer, organizer_name varchar(255), rating real, short_link varchar(255), city varchar(255), state varchar(255), country varchar(255), zip varchar(15), visibility varchar(50), who varchar(100))",
			...
			"create table venue(id integer primary key, address_1 varchar(255), address_2 varchar(255), city varchar(255), state varchar(255), country varchar(255), zip varchar(15), lat real, lon real)",
			...
			"create table photo_album(id integer primary key, album_photo integer, group_id integer, event_id integer, created integer, updated integer, CONSTRAINT fk_group_id FOREIGN KEY (group_id) REFERENCES mgroup(id), CONSTRAINT fk_event_id FOREIGN KEY (event_id) REFERENCES event(id), CONSTRAINT fk_album_photo_id FOREIGN KEY (album_photo) REFERENCES photo(id))"
		};
