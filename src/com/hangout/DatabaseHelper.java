...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String[] create = new String[] {
			"create table checkin(id integer primary key, comment text, lat real, lon real, event_id varchar(50), group_id integer, member_id integer, time integer, CONSTRAINT fk_group_id FOREIGN KEY (group_id) REFERENCES mgroup(id), CONSTRAINT fk_event_id FOREIGN KEY (event_id) REFERENCES event(id), CONSTRAINT fk_member_id FOREIGN KEY (member_id) REFERENCES member(id))",
			...
			"create table photo(id integer primary key, highres_link varchar(255), thumb_link varchar(255), photo_link varchar(255), caption varchar(255), created integer, updated integer, album_id integer, member_id integer, CONSTRAINT fk_album_id FOREIGN KEY (album_id) REFERENCES photo_album(id), CONSTRAINT fk_member_id FOREIGN KEY (member_id) REFERENCES member(id))",
